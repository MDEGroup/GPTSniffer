...
if (values.length < 4) { // array should have at least 4 elements
return false;
}
...
/**
    ...
    Test program that prompts the user to enter a series of integers and displays if the series contains
