...
public class TaxCalculator {
    public static void main(String[] args) {
        ...
        } else if (status == 1) {  for married filing jointly or qualifying widow(er)
            
            
        } else if (status == 2) {  for married filing separately
            
            
        } else if (status == 3) {  for head of household
